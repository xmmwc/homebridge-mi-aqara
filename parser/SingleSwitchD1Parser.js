...
class SingleSwitchD1Parser extends DeviceParser {
    ...
    getAccessoriesParserInfo() {
        return {
            'SingleSwitchD1_Switch': SingleSwitchD1SwitchParser
        }
    }
}
SingleSwitchD1Parser.modelName = ['switch', 'switch.b1lacn02'];
module.exports = SingleSwitchD1Parser;

class SingleSwitchD1SwitchParser extends AccessoryParser {
